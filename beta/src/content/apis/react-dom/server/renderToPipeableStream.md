...
This API is specific to Node.js. Environments with [Web Streams,](https://developer.mozilla.org/zh-CN/docs/Web/API/Streams_API) like Deno and modern edge runtimes, should use [`renderToReadableStream`](/apis/react-dom/server/renderToReadableStream) instead.
