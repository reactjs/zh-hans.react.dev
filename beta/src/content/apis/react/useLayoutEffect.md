...
3. Your `useLayoutEffect` [measures the height](https://developer.mozilla.org/zh-CN/docs/Web/API/Element/getBoundingClientRect) of the tooltip content and triggers an immediate re-render.
