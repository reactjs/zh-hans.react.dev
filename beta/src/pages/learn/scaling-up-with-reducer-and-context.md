...
## 结合使用 reducer 和 context {/_combining-a-reducer-with-context_/}
...
### 第一步: 创建 context {/_step-1-create-the-context_/}
...
### 第二步: 将 state 和 dispatch 函数 放入 context {/_step-2-put-state-and-dispatch-into-context_/}
...
### Step 3: 在组件树中的任何地方使用 context {/_step-3-use-context-anywhere-in-the-tree_/}
...
## 将所有的连接部分放入一个文件 {/_moving-all-wiring-into-a-single-file_/}
...
随着应用的增长，你可能会有许多这样的 context 和 reducer 的组合。这是一种强大的方法，可以拓展你的应用并 [提升状态](/learn/sharing-state-between-components)，而无需在你想要访问组件树深处的数据时进行太多工作。
