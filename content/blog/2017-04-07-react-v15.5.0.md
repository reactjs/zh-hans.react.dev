...
* 为 `React.createClass` 增加一个独立的警告。将用户指向 create-react-class。（[@acdlite](https://github.com/acdlite) 在 [d9a4fa4](https://github.com/facebook/react/commit/d9a4fa4f51c6da895e1655f32255cf72c0fe620e) 的提交）
