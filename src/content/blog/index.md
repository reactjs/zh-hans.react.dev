...
React 18 经过多年的努力才得以问世，它为 React 团队带来了宝贵的经验教训。它的发布是多年的研究和探索的结果。其中一些路径是成功的，但更多的是死胡同，但是也带来了新的见解。我们学到的一个教训是，如果无法了解我们正在探索的这些路径，那么社区在等待新功能的过程中将会非常沮丧……
</BlogCard>
...
- 我们开始对 React 18 添加开发，这将是我们的下一个主要版本。
