...
React 事件对象实现了一些标准的 [`事件`](https://developer.mozilla.org/en-US/docs/Web/API/Event) 方法：

* [`preventDefault()`](https://developer.mozilla.org/en-US/docs/Web/API/Event/preventDefault): 阻止事件的默认浏览器行为。
* [`stopPropagation()`](https://developer.mozilla.org/en-US/docs/Web/API/Event/stopPropagation): 阻止事件在 React 树中的传播。

此外，React事件对象提供了以下方法：

* `isDefaultPrevented()`: 返回一个布尔值，指示是否调用了`preventDefault`方法。
* `isPropagationStopped()`: 返回一个布尔值，指示是否调用了 `stopPropagation` 方法。
* `persist()`: 不适用于React DOM。在React Native中，调用此函数以读取事件后的属性。
...
#### 参数 {/*动画事件-handler-parameters*/}

* `e`: 带有这些额外[`动画事件`](https://developer.mozilla.org/en-US/docs/Web/API/动画事件)属性的[React事件对象](#react-event-object)：
  * [`animationName`](https://developer.mozilla.org/en-US/docs/Web/API/动画事件/animationName)
  * [`elapsedTime`](https://developer.mozilla.org/en-US/docs/Web/API/动画事件/elapsedTime)
  * [`pseudoElement`](https://developer.mozilla.org/en-US/docs/Web/API/动画事件)

---

### `ClipboardEvent`处理函数 {/*clipboadevent-handler*/}

一个用于 [剪贴板 API](https://developer.mozilla.org/zh-CN/docs/Web/API/Clipboard_API) 事件的处理程序类型。
...
* `e`: 带有这些额外[`ClipboardEvent`](https://developer.mozilla.org/en-US/docs/Web/API/ClipboardEvent)属性的[React事件对象](#react-event-object)：
...
一个用于 [输入法编辑器（IME）](https://developer.mozilla.org/en-US/docs/Glossary/Input_method_editor)事件的事件处理程序类型。
...
* `e`:具有这些额外[`CompositionEvent`](https://developer.mozilla.org/en-US/docs/Web/API/CompositionEvent) 属性的React事件对象
...
### `DragEvent` 处理 {/*dragevent-handler*/}
 ...
 一个[HTML 拖放 API](https://developer.mozilla.org/en-US/docs/Web/API/HTML_Drag_and_Drop_API)  事件的一个事件处理程序类型。
...
* `e`:一个带有这些额外的DragEvent属性的[React事件对象]：
  * [`dataTransfer`](https://developer.mozilla.org/en-US/docs/Web/API/DragEvent/dataTransfer)

  它还包括继承的[`MouseEvent`](https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent)属性：
  ...
  * [`shiftKey`](https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/shiftKey)
  ...
  它还包括继承的 [`UIEvent`](https://developer.mozilla.org/en-US/docs/Web/API/UIEvent) 属性:
...
* `e`: 一个有额外[`FocusEvent`](https://developer.mozilla.org/en-US/docs/Web/API/FocusEvent) 属性的[React事件对象](#react-event-object) :
...
### `Event` 处理函数 {/*event-handler*/}
 ...
 一个 event handler type for generic events.
...
### `InputEvent` 处理函数 {/*inputevent-handler*/}
 ...
 一个 event handler type for the `onBeforeInput` event.
...
### `KeyboardEvent` 处理函数 {/*keyboardevent-handler*/}
 ...
 一个 event handler type for keyboard events.
...
### `MouseEvent` 处理函数 {/*mouseevent-handler*/}
 ...
 一个 event handler type for mouse events.
...
* `e`: A [React event object](#react-event-object) with these extra [`鼠标事件`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件) properties:
  * [`altKey`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/altKey)
  * [`button`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/button)
  * [`buttons`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/buttons)
  * [`ctrlKey`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/ctrlKey)
  * [`clientX`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/clientX)
  * [`clientY`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/clientY)
  * [`getModifierState(key)`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/getModifierState)
  * [`metaKey`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/metaKey)
  * [`movementX`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/movementX)
  * [`movementY`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/movementY)
  * [`pageX`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/pageX)
  * [`pageY`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/pageY)
  * [`relatedTarget`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/relatedTarget)
  * [`screenX`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/screenX)
  * [`screenY`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/screenY)
  * [`shiftKey`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件/shiftKey)
...
### `PointerEvent` 处理函数 {/*pointerevent-handler*/}
 ...
 一个 event handler type for [pointer events.](https://developer.mozilla.org/en-US/docs/Web/API/Pointer_events)
...
* `e`: A [React event object](#react-event-object) with these extra [`PointerEvent`](https://developer.mozilla.org/en-US/docs/Web/API/PointerEvent) properties:
  ...
  * [`width`](https://developer.mozilla.org/en-US/docs/Web/API/PointerEvent/width)
  ...
  It also includes the inherited [`鼠标事件`](https://developer.mozilla.org/en-US/docs/Web/API/鼠标事件) properties:
...
### `TouchEvent` 处理函数 {/*touchevent-handler*/}
 ...
 一个 event handler type for [touch events.](https://developer.mozilla.org/en-US/docs/Web/API/Touch_events)
...
### `TransitionEvent` 处理函数 {/*transitionevent-handler*/}
 ...
 一个 event handler type for the CSS transition events.
...
### `UIEvent` 处理函数 {/*uievent-handler*/}
 ...
 一个 event handler type for generic UI events.
...
### `WheelEvent` 处理函数 {/*wheelevent-handler*/}
 ...
 一个 event handler type for the `onWheel` event.
...
**这很危险。与底层的DOM [`innerHTML`](https://developer.mozilla.org/en-US/docs/Web/API/Element/innerHTML) 属性一样,你必须极度谨慎！ 除非标记语言来自完全可信的来源, 否则通过这种方式引入 [XSS](https://en.wikipedia.org/wiki/Cross-site_scripting) 是容易被攻击的。**

例如，如果你使用将Markdown转换为HTML的Markdown库，你得相信它的解析器没有漏洞， 用户只能看到自己的输入，你可以像这样显示生成的HTML:
