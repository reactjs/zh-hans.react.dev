...
This API depends on [Web Streams.](https://developer.mozilla.org/zh-CN/docs/Web/API/Streams_API) For Node.js, use [`renderToPipeableStream`](/reference/react-dom/server/renderToPipeableStream) instead.
...
* **optional** `options`: An object with streaming options.
  ...
  * **optional** `nonce`: A [`nonce`](http://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/script#nonce) string to allow scripts for [`script-src` Content-Security-Policy](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Headers/Content-Security-Policy/script-src).
...
React will inject the [doctype](https://developer.mozilla.org/zh-CN/docs/Glossary/Doctype) and your <CodeStep step={2}>bootstrap `<script>` tags</CodeStep> into the resulting HTML stream:
