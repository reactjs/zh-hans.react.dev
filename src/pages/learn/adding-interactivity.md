...
屏幕上的一些东西会根据用户的输入而更新。例如，点击图片库切换活动的图片。在 React 中，随时间变化的数据被称为状态。你可以向任何组件添加状态，并根据需要进行更新。在本章中，你将学习如何编写处理交互的组件，更新它们的状态，并随着时间推移显示不同的输出。
...
或者，如果你已经熟悉这些主题，为什么不看看 [状态管理](/learn/managing-state)？
